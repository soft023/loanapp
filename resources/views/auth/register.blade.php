                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                         ...
                         <h4 class="mb-50">Registration Form</h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right">{{ __('Middlename') }}</label>
                      ...
                      <div class="form-group row">
                            <label for="surname" class="col-md-4 col-form-label text-md-right">{{ __('Lastname') }}</label>
                      ...
                      <div class="form-group row">
                            <label for="Nature Of Job" class="col-md-4 col-form-label text-md-right">{{ __('Nature Of Job') }}</label>

                            <div class="col-md-6">
                                <select class="form-control text-center" style="font-size:12pt;" name="jobclassification" id="jobclassification" >
