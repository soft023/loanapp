...
font-size: 16px;">  
 ...
 <form class="form" method="POST" action="/loangrantx" >
         @csrf
...
<div class="row">
  <div class="col-md-12">
   ...
   <div class="card w3-card w3-pink">
    ...
    <h2 class="text-center w3-white"><b>Loan Grant Form </b></h2>
    ...
    <div class="col-sm-12 col-md-6">
     ...
     <div class="form-group{{ $errors->has('reasonforyes') ? ' has-error' : '' }} w3-margin">
        <b class="">Reason For Granting</b>:<br>
    <textarea class="form-control text-center" name="reasonforyes" rows="3" placeholder="...write the reason why the facility is worth giving...." style=" font-size:13pt;" required/></textarea> 
    

      @if ($errors->has('reasonforyes'))
      <span class="help-block">
       <strong>{{ $errors->first('reasonforyes') }}</strong>
     </span>
     @endif
   </div>
 </div>
 ...
 <div class="row">
     <div class="col-sm-12 col-md-3 "></div>
    <div class="col-sm-12 col-md-6 ">
        <div class="form-group{{ $errors->has('amountgranted') ? ' has-error' : '' }} w3-margin">
         <b>Amount Grant:</b>
        <input id="amountgranted" type="text" style="font-size:13pt;" class="form-control text-center"  name="amountgranted" placeholder="Enter Approved Amount"  required>

        @if ($errors->has('amountgranted'))
        <span class="help-block">
         <strong>{{ $errors->first('amountgranted') }}</strong>
       </span>
       @endif
     </div>
   </div>
