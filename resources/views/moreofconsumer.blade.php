...
<div class="col-md-12">
<div class="w3-card w3-yellow ">
@foreach($jobprofile as $pro)<br>
<img src= "../consumer/passport/{{$pro['passport']}}" class="user-image img-responsive"/>
<h2><b>Job Informations</h2></b>
 <h3 class="w3-margin"><b>Employment Status :  </b> {{$pro['employmentstatus']}}</h3>
 <h3 class="w3-margin"><b>Current Work Place :  </b> {{$pro['currentworkplace']}}</h3>
 <h3 class="w3-margin"><b>Work Place Address :  </b> {{$pro['workplaceaddress']}}</h3>
 <h3 class="w3-margin"><b>Closest Landmark :  </b> {{$pro['closestlandmark']}}</h3>
 <h3 class="w3-margin"><b>Department :  </b> {{$pro['department']}}</h3>
 <h3 class="w3-margin"><b>Net Salary Monthly :  </b> {{$pro['netmonthlysalary']}}</h3>
 <h3 class="w3-margin"><b>Office Email Address :  </b> {{$pro['officeemail']}}</h3>
 <h3 class="w3-margin"><b>Pay Day :  </b> {{$pro['payday']}}</h3>
...
<h2><b>Other Information</h2></b>
  ...
  <h3 class="w3-margin"><b>Passport:  </b><a  class=" w3-red" href="../consumer/passport/{{$pro['passport']}}">
 Click To Get Passpo</a></h3>
  @endif 


 @if (!empty($pro['pensionstatement']))
  <h3 class="w3-margin"><b>Pension Statement:  </b><a  class=" w3-red" href="../consumer/pensionstatement/{{$pro['pensionstatement']}}">
 Click To Statement</a></h3>
  @endif 



 @if (!empty($pro['staffID']))
  <h3 class="w3-margin"><b>Staff ID :  </b><a  class=" w3-red" href="../consumer/staffid/{{$pro['staffID']}}">
 Click To Staff ID </a></h3>
  @endif 

 @if (!empty($pro['otherid']))
 <h3 class="w3-margin"><b>Other ID :  </b><a  class=" w3-red" href="../consumer/otherid/{{$pro['otherid']}}"> Click To get Other  ID</a></h3>
  @endif 
  @endforeach 
